...
### Added
- ✨ Add pixel8-tui, a terminal frontend for the console.
...
- ♻️ Expose the console as a library, gating the window stack.
...
### Fixed
- 🐛 Hide the software cursor in the terminal frontend.
- 🐛 Keep the pixel8 binary building without the window feature.
