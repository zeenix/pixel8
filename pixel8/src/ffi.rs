...
//! explicit, C-like import set in the `"pixel8"` module. Carts cannot
...
#[link(wasm_import_module = "pixel8")]
extern "C" {
...
mod stubs {
    ...
    pub unsafe fn sprite(_n: u32, _x: i32, _y: i32, _w: i32, _h: i32, _flip_x: i32, _flip_y: i32) {}
    pub unsafe fn map(
        _cel_x: i32,
        _cel_y: i32,
        _sx: i32,
