...
//!
//! Pixel8 is a loving homage to [PICO-8](https://www.lexaloffle.com/pico-8.php):
...
//! Pixel8 project almost one-to-one. This module does exactly that.
//!
...
/// flag saying which. Pixel8 de-aliases the two (it has a full 256-sprite
